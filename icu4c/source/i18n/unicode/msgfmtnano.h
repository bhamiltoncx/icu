...
public:
    ...
    virtual int32_t findSubMessage(const MessagePattern& /*pattern*/, int32_t /*partIndex*/, const Selector& /*selector*/, void* /*context*/, double /*number*/, UErrorCode& status) const {
        status = U_UNSUPPORTED_ERROR;
        return -1;
    }
